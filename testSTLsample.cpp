...
namespace jj00 {
    ...
    void test_misc() {
        ...
        cout << size_t(-1) << endl;                                //4294967295  x64:18446744073709551615
        cout << size_t(-1) / sizeof(long) << endl;                //1073741823    4611686018427387903
        cout << size_t(-1) / sizeof(string) << endl;                //1073741823    576460752303423487
        cout << size_t(-1) / sizeof(_List_node < string > ) << endl;    //357913941 384307168202282325
        cout << size_t(-1) / sizeof(_Fwd_list_node < string > ) << endl; //536870911    461168601842738790
...
//    array.front()= 41
//    array.back()= 29794
//    array.data()= 0xf7ebc17240
//    target (0~32767): 3255
//    qsort()+bsearch(), milli-seconds : 32
//    found, 3255
...
//以下先暫時迴避上述疑問.
    ...
    void test_list_with_special_allocator() {
        ...
        list <string, __gnu_cxx::bitmap_allocator<string>> c6;    //47814
...
namespace jj25 {
    void test_components_sizeof() {
        ...
        cout << "sizeof(_Rb_tree<...>::iterator)= "
             << sizeof(_Rb_tree < int, int, _Identity < int >, less < int >> ::iterator) << endl; //4
        //allocators
        ...
        cout << "sizeof(__gnu_cxx::bitmap_allocator<string>)= " << sizeof(__gnu_cxx::bitmap_allocator<string>)
             << endl; //1 (理論值 0)
        cout << "sizeof(__gnu_cxx::__mt_alloc<string>)= " << sizeof(__gnu_cxx::__mt_alloc<string>)
             << endl;            //1 (理論值 0)
//	cout << "sizeof(__gnu_cxx::array_allocator<int>)= " << sizeof(__gnu_cxx::array_allocator<int>) << endl;  		//8
        ...
        cout << "sizeof(__gnu_cxx::debug_allocator<std::allocator<double>>)= "
             << sizeof(__gnu_cxx::debug_allocator<std::allocator<double>>) << endl; //8
    }
}
//---------------------------------------------------
#include <vector>
...
//    jj00::test_misc(); //测试标准库最大容量
//        jj01::test_array();   //测试array
        long value=5000000L;
//        jj02::test_vector(value);    //测试vector
//        jj03::test_list(value);
//        jj04::test_forward_list(value);
//    jj05::test_deque(value);
//    jj06::test_multiset(value);
...
//    jj31::test_Rb_tree();   //测试使用红黑树

//    jj33::test_iterator_category();
jj34::test_accumulate();


//    jjxx::test_containers();  //测试所有容器
//
//    jj20::test_list_with_special_allocator();
//    jj25::test_components_sizeof();
//    jj30::test_all_components();
